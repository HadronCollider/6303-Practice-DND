...
public class StrTransform {
    ...
    public void formatSwitch(char c) {
        switch (c) {
            case '1':
                bufferWord.sizeMode = 1;
                break;
            case '2':
                bufferWord.sizeMode = 2;
                break;
            case '3':
                bufferWord.sizeMode = 3;
                break;
            case '4':
                bufferWord.sizeMode = 4;
                break;
            case '5':
                bufferWord.sizeMode = 5;
                break;
            case '6':
                bufferWord.sizeMode = 6;
                break;
            case 'р':
            case 'о':
            case 'з':
            ...
            case 'ч':
            case 'е':
                bufferWord.setColor(c);
                break;
            case '\\':
                bufferWord.hasLineBreak = true;
                break;
        }
    }
...
class Word {
    ...
    public void setColor(char symb) {
        switch (symb) {
            case 'р':
                color = new Color(252, 15, 192);
                break;
            case 'о':
                color = new Color(255, 104, 0);
                break;
            case 'з':
                color = new Color(0, 255, 0);
                break;
            case 'г':
                color = new Color(0, 184, 217);
                break;
            case 'с':
